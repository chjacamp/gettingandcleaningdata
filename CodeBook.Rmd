...
A. SubjectID - The subjects are identified in an integer vector from 1 to 30.

B. Activity - The activity being performed in a character vector consisting of the levels:
  "Walking"
  "Walking_upstairs"
  "Walking_downstairs"
  "Standing"
...
C. Columns 3-88 contain the names of the measurements relating to mean and standard deviation.
